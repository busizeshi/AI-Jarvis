...
| 用途 | 技术选型 | 说明 |
|------|---------|------|
| 关系数据（主） | MySQL 8.0 | 用户、知识库、笔记元数据、权限、陪伴关系 |
...
| 基础设施 | Docker Compose 本地开发环境、MySQL/Redis/Milvus/ES/MinIO 启动脚本 |
...
| 知识库服务 | CRUD/版本/双向链接/智能标签 | MySQL + Redis |
